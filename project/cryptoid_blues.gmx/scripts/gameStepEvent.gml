...
with oMoveableSolid
{
  ...
  for(y=y;y<yMPrev+yVel;y+=1)
  {
    ...
    if place_meeting(x,y+1,oSolid) or isCollisionCharacterBottom(1) and launched = 0
    {
      yVel=0
      break
    }      
...
//part_attractor_position(firefly_system, firefly_attract, oPlayer1.x, oPlayer1.y)
